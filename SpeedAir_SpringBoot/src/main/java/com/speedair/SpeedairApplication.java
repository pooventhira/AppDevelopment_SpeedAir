...
public class SpeedairApplication {
	...
	public void initUsers() {
		List<User> users = Stream.of(
			new User(null, "user1", "user1@gmail.com", "1234", "1234567890", "a", "user", "company1", "a"),
			new User(null, "user2", "user2@gmail.com", "1234", "1234567890", "a", "user", "company2", "a"),
			new User(null, "user3", "user3@gmail.com", "1234", "1234567890", "a", "user", "company2", "a")
